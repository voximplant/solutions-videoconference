...
interface VILogMessage {
    message: string;
    meta: VILoggerMeta;
}

interface VICallbackLoggerInit {
    logLevel?: VILoggerLevelStrings;
    loggerCallback: (evt: VILogMessage[]) => void;
}

declare class CallbackLogger extends VILogger {
    settings: VICallbackLoggerInit;
    private tempLogs;
    constructor(loggerConfig: VICallbackLoggerInit);
    protected handleLog(message: string, meta: VILoggerMeta): void;
    handleCallback(): void;
}

interface VIConsoleLoggerInit {
    prettyPrint?: boolean;
    displayMeta?: boolean;
    logLevel?: VILoggerLevelStrings;
}

declare class ConsoleLogger extends VILogger {
    settings: VIConsoleLoggerInit;
    constructor(loggerConfig?: VIConsoleLoggerInit);
    protected handleLog(message: string, meta: VILoggerMeta): void;
    private printConsole;
    private prettyPrint;
}

export { CallbackLogger, ConsoleLogger };
